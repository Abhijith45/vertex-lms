    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 p-4 sm:p-6 pointer-events-none flex justify-center">
      <div className="pointer-events-auto w-full max-w-[1400px] rounded-2xl border border-neutral-200/90 dark:border-neutral-800 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md px-6 py-4 shadow-xl shadow-neutral-900/10 dark:shadow-black/40 flex flex-col sm:flex-row items-center justify-between gap-4 transition-all duration-200">
        ...
        <div className="flex items-center gap-4 w-full sm:w-auto">
          <div>
            <span className="block text-xs font-semibold text-neutral-500 dark:text-neutral-400 tracking-wider">
              Your Progress
            </span>
            <span className="text-base font-bold text-neutral-900 dark:text-neutral-100 font-sans">
              {progressPercentage}% complete
            </span>
          </div>

          {/* Mobile progress bar (inline) */}
          <div className="sm:hidden flex-1 h-2 bg-neutral-200 dark:bg-neutral-800 rounded-full overflow-hidden">
            <div
        ...
        <div className="hidden sm:block flex-1 max-w-md mx-6">
          <div className="h-2 w-full bg-neutral-200/80 dark:bg-neutral-800 rounded-full overflow-hidden">
            <div
              className="h-full bg-[#E05A36] rounded-full transition-all duration-500"
              style={{ width: `${progressPercentage}%` }}
              role="progressbar"
